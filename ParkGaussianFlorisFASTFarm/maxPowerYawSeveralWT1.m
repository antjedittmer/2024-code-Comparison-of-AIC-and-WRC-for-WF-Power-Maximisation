function [Psum,P,V] = maxPowerYawSeveralWT1(gammaVec)
...
b   = 0.022; % 0.022; % model parameters wake interaction 0.022
...
for idx = 1 : n
    ...
    a1 = interp1(gammaVec1,a1Vec,abs(gammaDeg));
    gamma =  gammaRad(idx);
    ...
    idx1 = interp1(gammaVec1,1 : length(gammaVec1),abs(gammaDeg));
...
P = 1/2* rho * A* Cp .* (U' .* [cos(gammaRad); 1]).^3;
