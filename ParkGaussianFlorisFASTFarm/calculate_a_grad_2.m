function [a_best,p,a_grad] = calculate_a_grad_2(a_k,del,c,rho,A,Vinf,p,PT_I,plotOff)
...
% update the last (third) vector
for idxn = 1:(l_N-1) %idxn stands for index_neighbors
