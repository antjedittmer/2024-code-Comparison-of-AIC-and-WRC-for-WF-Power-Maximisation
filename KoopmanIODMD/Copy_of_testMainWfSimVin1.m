...
%filenameVal = 'Vinf8dot0_sowfa_2turb_alm_turbl.mat'; % 'Vinf8dot0_sowfa_2turb_yaw_steps'; %

filenameVal = 'Vinf8dot0_sowfa_2turb_alm_turbl_AllComb.mat'; %'Vinf8dot0_sowfa_2turb_alm_turbl'; %'Vinf8dot5_sowfa_2turb_alm_turbl_AllComb.mat';
%
...
if yawmode == 0 %pitch control
    ...
    sepStr = strfind(filenameId,'_');
    dirNameVal = fullfile(DataIn, [filenameVal(1:sepStr-1),'_OL_Ct'], filenameVal);
...
nTx = 1; round(Wp.turbine.Crx(1)/Wp.mesh.Lx * Wp.mesh.Nx)-1;
nTy = 1; round(Wp.turbine.Cry(1)/Wp.mesh.Ly * Wp.mesh.Ny);
